...
class TestAiHumanCardProjector(unittest.TestCase):
    ...
    def test_plan_ready_projects_json_scalars_without_invented_pct(self) -> None:
        ...
        print(" plan_ready payload:", ready.get("payload"))
        self.assertEqual((ready.get("payload") or {}).get("run_id"), "run_demo")
        self.assertEqual((ready.get("payload") or {}).get("plan_id"), "plan_demo")
        self.assertNotIn("data-open-plan", ready["text"])
