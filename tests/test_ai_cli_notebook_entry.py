...
class TestAiCliNotebookEntry(unittest.TestCase):
    ...
    def test_cli_plan_command_human_default(self) -> None:
        ...
        self.assertIn("Plan ready.", completed.stdout)
        self.assertIn("plan_id:", completed.stdout)
        self.assertIn("just discuss", completed.stdout)
        self.assertIn("run this plan", completed.stdout)
        self.assertNotIn("Job:", completed.stdout)
        self.assertNotIn("Calls: qteasy.built_in_list", completed.stdout)
        self.assertNotIn("Confirm: qteasy-ai run --plan-id", completed.stdout)
        self.assertNotIn("Storage:", completed.stdout)
